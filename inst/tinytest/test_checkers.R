...
expect_false(isTRUE(check_trackframe(tf_mini[mini_reorder, ], unsorted.ok = FALSE)))
...
expect_false(isTRUE(check_trackframe(paths_trackframe[paths_reorder, ], unsorted.ok = FALSE)))
